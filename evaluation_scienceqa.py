...
def main():
    ...
    # 设置特殊标记ID
    model.config.pad_token_id = tokenizer.pad_token_id = 0  # 填充标记
    model.config.bos_token_id = tokenizer.bos_token_id = 1  # 开始标记
    model.config.eos_token_id = tokenizer.eos_token_id = 2  # 结束标记
