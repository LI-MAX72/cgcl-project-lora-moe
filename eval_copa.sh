...
python evaluation_scienceqa.py \
         --test_dataset "/home/sub6-zt/caonan/dataset/copa_test_all.json" \
         --base_model "/home/sub6-zt/caonan/model/Llama-3.1-8B" \
         --mola_weights "/home/sub6-zt/caonan/MoLA_l3_last/results/qa_copa_mola-10ep-2" \
         --batch_size 8 \
         ...
         --save_path "./eval/qa_copa_mola-10ep-2.json"